...
export async function loadPlugins(
  ...
  const orderedPlugins = getDependencyOrder(configs, loadedPlugins)
 ...
 */
export function getDependencyOrder<T extends GenericProviderConfig>(configs: T[], loadedPlugins: PluginMap): string[] {
